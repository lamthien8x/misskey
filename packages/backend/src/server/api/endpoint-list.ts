...
export * as 'following/purchase' from './endpoints/following/purchase.js';
export * as 'following/sepay-init' from './endpoints/following/sepay-init.js';
export * as 'following/sepay-qr' from './endpoints/following/sepay-qr.js';
export * as 'webhooks/sepay' from './endpoints/webhooks/sepay.js';
export * as 'help/create' from './endpoints/help/create.js';
export * as 'help/list' from './endpoints/help/list.js';
export * as 'help/show' from './endpoints/help/show.js';
export * as 'help/support-init' from './endpoints/help/support-init.js';
export * as 'help/support-status' from './endpoints/help/support-status.js';
export * as 'help/contrib-list' from './endpoints/help/contrib-list.js';
export * as 'help/update-status' from './endpoints/help/update-status.js';
export * as 'help/gift-confirm' from './endpoints/help/gift-confirm.js';
export * as 'help/gift-report' from './endpoints/help/gift-report.js';
export * as 'help/admin-list' from './endpoints/help/admin-list.js';
export * as 'help/my-supports' from './endpoints/help/my-supports.js';
