...
export type FollowingPurchaseRequest = operations['following___purchase']['requestBody']['content']['application/json'];
export type FollowingPurchaseResponse = operations['following___purchase']['responses']['200']['content']['application/json'];
...
export type FollowingSepayInitRequest = operations['following___sepay-init']['requestBody']['content']['application/json'];
export type FollowingSepayInitResponse = operations['following___sepay-init']['responses']['200']['content']['application/json'];
export type FollowingSepayQrRequest = operations['following___sepay-qr']['requestBody']['content']['application/json'];
export type FollowingSepayQrResponse = operations['following___sepay-qr']['responses']['200']['content']['application/json'];
...
export type HelpAdminListRequest = operations['help___admin-list']['requestBody']['content']['application/json'];
export type HelpAdminListResponse = operations['help___admin-list']['responses']['200']['content']['application/json'];
export type HelpContribListRequest = operations['help___contrib-list']['requestBody']['content']['application/json'];
export type HelpContribListResponse = operations['help___contrib-list']['responses']['200']['content']['application/json'];
export type HelpCreateRequest = operations['help___create']['requestBody']['content']['application/json'];
export type HelpCreateResponse = operations['help___create']['responses']['200']['content']['application/json'];
export type HelpGiftConfirmRequest = operations['help___gift-confirm']['requestBody']['content']['application/json'];
export type HelpGiftConfirmResponse = operations['help___gift-confirm']['responses']['200']['content']['application/json'];
export type HelpGiftReportRequest = operations['help___gift-report']['requestBody']['content']['application/json'];
export type HelpGiftReportResponse = operations['help___gift-report']['responses']['200']['content']['application/json'];
export type HelpListRequest = operations['help___list']['requestBody']['content']['application/json'];
export type HelpListResponse = operations['help___list']['responses']['200']['content']['application/json'];
export type HelpMySupportsResponse = operations['help___my-supports']['responses']['200']['content']['application/json'];
export type HelpShowRequest = operations['help___show']['requestBody']['content']['application/json'];
export type HelpShowResponse = operations['help___show']['responses']['200']['content']['application/json'];
export type HelpSupportInitRequest = operations['help___support-init']['requestBody']['content']['application/json'];
export type HelpSupportInitResponse = operations['help___support-init']['responses']['200']['content']['application/json'];
export type HelpSupportStatusRequest = operations['help___support-status']['requestBody']['content']['application/json'];
export type HelpSupportStatusResponse = operations['help___support-status']['responses']['200']['content']['application/json'];
export type HelpUpdateStatusRequest = operations['help___update-status']['requestBody']['content']['application/json'];
export type HelpUpdateStatusResponse = operations['help___update-status']['responses']['200']['content']['application/json'];
...
export type WebhooksSepayRequest = operations['webhooks___sepay']['requestBody']['content']['application/json'];
export type WebhooksSepayResponse = operations['webhooks___sepay']['responses']['200']['content']['application/json'];
